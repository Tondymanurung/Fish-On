...
<head>
	<title>FISHON</title>
	<link rel="icon" href="image/home/Logo Fish On.png">
	...
	<div class="container-fluid">
		<div class="row top" >
			<center>
				...
				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> fishonacehbarat@gmail.com</span>
				</div>

				<div class="col-md-4"  style="padding: 3px;">
					<span>FISHON Meulaboh Aceh Barat Indonesia</span>
				</div>
			</center>
		</div>
	</div>

	<nav class="navbar navbar-default" style="padding: 5px; background-color: transparent; border: none;">
		<div class="container">
			...
			<a href="index.php"> <img src="image/home/Logo Fish On1.png" style="width: 7%;  height: 7%;" />
			<img src="image/home/FISH ON copy.png" width="10%" height="10%" alt="" title=""/></a>
